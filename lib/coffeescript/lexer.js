...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    literalToken() {
      ...
      if (value === ';') {
        ...
        tag = 'BIN?';
      } else if (value === '|' && indexOf.call(LINE_BREAK, this.tag()) >= 0) {
        tag = 'MATCH_PIPE';
      } else if (prev) {
  ...
  COFFEE_KEYWORDS = ['undefined', 'Infinity', 'NaN', 'then', 'unless', 'until', 'loop', 'of', 'by', 'when', 'let', 'match'];
  ...
  RESERVED = ['case', 'function', 'var', 'void', 'with', 'const', 'enum', 'native', 'implements', 'interface', 'package', 'private', 'protected', 'public', 'static'];
