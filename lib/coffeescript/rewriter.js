...
(function() {
    ...
    class Rewriter {
      ...
      tagPostfixConditionals() {
        ...
        return this.scanTokens(function(token, i) {
          ...
          // `| pattern if guard -> body`. Detected by MATCH_PIPE in backwards scan.
  ...
  exports.UNFINISHED = UNFINISHED = ['\\', '.', '?.', '?::', 'UNARY', 'DO', 'DO_IIFE', 'MATH', 'UNARY_MATH', '+', '-', '**', 'SHIFT', 'RELATION', 'COMPARE', '&', '^', '|', '&&', '||', 'BIN?', 'EXTENDS', 'PIPE'];
