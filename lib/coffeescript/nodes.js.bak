      ...
      compileWithDeclarations(o) {
        ...
        if (scope.expressions === this) {
          ...
          if (declars || assigns) {
            ...
            fragments.push(this.makeCode(`${this.tab}${scope.shared ? 'var' : 'let'} `));
            if (declars) {
...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      compileNode(o) {
        var arg, argCode, argIndex, baseName, baseStr, cache, compiledArgs, fragments, j, lastProp, len1, methodName, receiverNode, receiverProps, ref1, ref2, ref3, ref4, ref5, ref6, rewriter, varAccess;
      ...
      checkConstMethodMutation(o) {
        var baseName, lastProp, methodName, ref1, ref2;
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      addScopeVariables(o, {allowAssignmentToExpansion = false, allowAssignmentToNontrailingSplat = false, allowAssignmentToEmptyArray = false, allowAssignmentToComplexSplat = false} = {}) {
        ...
        const isDestructuring = (typeof this.variable.isArray === "function" ? this.variable.isArray() : void 0) || (typeof this.variable.isObject === "function" ? this.variable.isObject() : void 0);
        return varBase.eachName((name) => {
          var alreadyDeclared, atTopLevel, commentFragments, commentsNode, declarationType, existingType, message;
          ...
          if (this.moduleDeclaration) {
            ...
            declarationType = this.letDeclaration ? 'let' : (atTopLevel && !isDestructuring) ? 'const' : 'var';
      ...
      compileNode(o) {
        var answer, base, baseName, baseNode, baseS, compiledName, idx, idxNum, idxS, isDyn, isIdxMut, isNumericIdx, isPropMut, isValue, lastProp, name, nextIdxS, prop, properties, prototype, ref1, ref2, ref3, ref4, ref5, shouldFreezeValue, val, valS, valueO, varBase;
      ...
      checkConstMutation(o) {
        var baseName, baseNode, isValue, lastProp, ref1;
        isValue = this.variable instanceof Value;
        ...
        if (this.operator === 'delete') {
          ...
          if (target instanceof Value && target.base instanceof IdentifierLiteral) {
            ...
            if ((ref1 = o.scope) != null ? ref1.check(baseName) : void 0) {
              if (o.scope.isConstVar(baseName) || o.scope.isLetVar(baseName)) {
                return this.error("The 'delete' operator is forbidden in immutable mode. " + "To remove a property, use destructuring: const {prop, ...rest} = obj");
              }
            }
          }
        }
