  ...
  exports.MatchArm = MatchArm = (function() {
    class MatchArm extends Base {
      ...
      compileArm(o, subjectFrags, isFirst) {
        let bindings, condFrags, f, guardFrags, idt, idt2, name, o2, opener, subjectCode;
        idt = o.indent;
        idt2 = idt + TAB;
        o2 = merge(o, {
          indent: idt2
