...
(function() {
  var CoffeeScript, Module, binary, cacheSourceMaps, child_process, ext, findExtension, fork, getRootModule, helpers, i, isNodeNativePrepareStackTrace, len, loadFile, nodeSourceMapsSupportEnabled, patchStackTrace, path, ref, ref1, ref2;
  ...
  isNodeNativePrepareStackTrace = ((ref1 = Error.prepareStackTrace) != null ? ref1.name : void 0) === 'ErrorPrepareStackTrace';
