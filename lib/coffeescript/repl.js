...
(function() {
  ...
  const runInContext = function(js, context, filename) {
    if (context === global) {
  ...
  const getCommandId = function(repl, commandName) {
  ...
  module.exports = {
    start: function(opts = {}) {
      let Module, build, major, minor, originalModuleLoad, ref, repl;
      if (typeof process !== "undefined" && process !== null ? (ref = process.versions) != null ? ref.bun : void 0 : void 0) {
      ...
      if (opts.transpile) {
        transpile = {};
        try {
          transpile = Object.freeze({...transpile, transpile: require('@babel/core').transform});
        } catch (error) {
          try {
            transpile = Object.freeze({...transpile, transpile: require('babel-core').transform});
          } catch (error) {
...
See https://coffeescript.org/#transpilation`);
        ...
        transpile = Object.freeze({...transpile, options: {
