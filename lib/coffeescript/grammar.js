...
(function() {
  ...
  let grammar = {
    ...
    Expression: [o('Value'), o('Code'), o('Operation'), o('Assign'), o('LetDeclaration'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Match'), o('Class'), o('Throw'), o('Yield')],
    ...
    Operation: [
      ...
      o('Expression COMPOSE_FWD Expression',
      function() {
        return new ComposeOp($1,
      $3);
      }),
  ...
  let operators = [['right', 'DO_IIFE'], ['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY', 'DO'], ['right', 'AWAIT'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', '&'], ['left', '^'], ['left', '|'], ['left', '&&'], ['left', '||'], ['left', 'BIN?'], ['left', 'COMPOSE_FWD'], ['left', 'PIPE'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', 'YIELD'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'FORFROM', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'IMPORT', 'EXPORT', 'DYNAMIC_IMPORT'], ['right', 'MATCH'], ['right', 'MATCH_PIPE'], ['left', 'POST_IF']];
