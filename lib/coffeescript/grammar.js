...
(function() {
  ...
  let Parser, alt, alternatives, name, token;
  ...
  const o = function(patternString, action, options) {
    let getAddDataToNodeFunctionString, m, patternCount, performActionFunctionString, returnsLoc;
    ...
    if (action) {
      ...
      // listed below.
      action = (m = unwrap.exec(action)) ? m[1] : `(${action}())`;
  ...
  let grammar = {
    ...
    // grammar.
    Line: Object.freeze([o('Expression'), o('ExpressionLine'), o('Statement'), o('FuncDirective')]),
    FuncDirective: Object.freeze([o('YieldReturn'), o('AwaitReturn')]),
    ...
    Expression: Object.freeze([o('Value'), o('Code'), o('Operation'), o('Assign'), o('LetDeclaration'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Match'), o('Class'), o('Throw'), o('Yield')]),
    ...
    LetDeclaration: Object.freeze([
      o('LET SimpleAssignable = Expression',
      function() {
        return new Assign($2,
      $4,
      null,
      ...
      o('LET SimpleAssignable = TERMINATOR Expression',
      function() {
        return new Assign($2,
      $5,
      null,
      ...
      o('LET SimpleAssignable = INDENT Expression OUTDENT',
      function() {
        return new Assign($2,
      $5,
      null,
    ...
    ExpressionLine: Object.freeze([o('CodeLine'), o('IfLine'), o('OperationLine')]),
    Yield: Object.freeze([
      o('YIELD',
      function() {
        return new Op($1,
    ...
    InterpolationChunk: Object.freeze([
    ...
    SimpleObjAssignable: Object.freeze([o('Identifier'), o('Property'), o('ThisProperty')]),
    ObjAssignable: Object.freeze([
    ...
    ObjSpreadIdentifier: Object.freeze([
    ...
    OptComma: Object.freeze([o(''), o(',')]),
    // The list of parameters that a function accepts can be of any length.
    ParamList: Object.freeze([
      o('',
      function() {
        return [];
      }),
    ...
    // Function Parameters
    ParamVar: Object.freeze([o('Identifier'), o('ThisProperty'), o('Array'), o('Object')]),
    ...
    SimpleAssignable: Object.freeze([
      o('Identifier',
      function() {
        return new Value($1);
      }),
    ...
    ImportSpecifierList: Object.freeze([
      o('ImportSpecifier',
      function() {
        return [$1];
      }),
    ...
    ImportDefaultSpecifier: Object.freeze([
      o('Identifier',
      function() {
        return new ImportDefaultSpecifier($1);
      })
    ]),
    ImportNamespaceSpecifier: Object.freeze([
    ...
    Export: Object.freeze([
      ...
      o('EXPORT LET SimpleAssignable = Expression',
      function() {
        return new ExportNamedDeclaration(LOC(3,
      5)(new Assign($3,
      $5,
      null,
      {
      ...
      o('EXPORT LET SimpleAssignable = TERMINATOR Expression',
      function() {
        return new ExportNamedDeclaration(LOC(3,
      6)(new Assign($3,
      $6,
      ...
      o('EXPORT LET SimpleAssignable = INDENT Expression OUTDENT',
      function() {
        return new ExportNamedDeclaration(LOC(3,
      7)(new Assign($3,
      $6,
    ...
    ExportSpecifierList: Object.freeze([
      o('ExportSpecifier',
      function() {
        return [$1];
      }),
    ...
    MatchArms: Object.freeze([
      o('MatchArm',
      function() {
        return [$1];
      }),
      o('MatchArms MatchArm',
      function() {
        return $1.concat($2);
      })
    ]),
    MatchArm: Object.freeze([
      o('MATCH_PIPE MatchPattern -> Block',
      function() {
        return new MatchArm($2,
      null,
      $4);
      }),
    ...
    MatchPattern: Object.freeze([
      o('Literal',
      function() {
        return new LiteralPattern($1);
      }),
      o('IDENTIFIER',
      function() {
        return new BindingPattern($1);
      }),
      o('MatchPattern , MatchPattern',
      function() {
        return new OrPattern($1,
      $3);
      })
    ]),
  ...
  let operators = Object.freeze([Object.freeze(['right', 'DO_IIFE']), Object.freeze(['left', '.', '?.', '::', '?::']), Object.freeze(['left', 'CALL_START', 'CALL_END']), Object.freeze(['nonassoc', '++', '--']), Object.freeze(['left', '?']), Object.freeze(['right', 'UNARY', 'DO']), Object.freeze(['right', 'AWAIT']), Object.freeze(['right', '**']), Object.freeze(['right', 'UNARY_MATH']), Object.freeze(['left', 'MATH']), Object.freeze(['left', '+', '-']), Object.freeze(['left', 'SHIFT']), Object.freeze(['left', 'RELATION']), Object.freeze(['left', 'COMPARE']), Object.freeze(['left', '&']), Object.freeze(['left', '^']), Object.freeze(['left', '|']), Object.freeze(['left', '&&']), Object.freeze(['left', '||']), Object.freeze(['left', 'BIN?']), Object.freeze(['left', 'PIPE']), Object.freeze(['nonassoc', 'INDENT', 'OUTDENT']), Object.freeze(['right', 'YIELD']), Object.freeze(['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS']), Object.freeze(['right', 'FORIN', 'FOROF', 'FORFROM', 'BY', 'WHEN']), Object.freeze(['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'IMPORT', 'EXPORT', 'DYNAMIC_IMPORT']), Object.freeze(['right', 'MATCH']), Object.freeze(['right', 'MATCH_PIPE']), Object.freeze(['left', 'POST_IF'])]);

  let tokens = Object.freeze([]);

  for (name in grammar) {
    alternatives = grammar[name];
    grammar = Object.freeze({...grammar, [name]: (function() {
      let i, j, len, len1, ref, results;
      results = [];
  ...
  exports.parser = new Parser({
    tokens: tokens.join(' '),
    bnf: grammar,
    operators: operators = Object.freeze(operators.toReversed()),
    startSymbol: 'Root'
  });
